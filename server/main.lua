...
TriggerEvent('esx_phone:registerNumber', 'fbi', TranslateCap('alert_fbi'), true, true)
TriggerEvent('esx_society:registerSociety', 'fbi', TranslateCap('society_fbi'), 'society_fbi', 'society_fbi', 'society_fbi', {type = 'public'})
